...
@ClientEndpoint
public class HomePageSocketClientSlave {
    ...
    public static void connect(String userId, String roomId, String token, String ws) throws Exception {
        ...
        Session session = container.connectToServer(HomePageSocketClientSlave.class, URI.create(ws));
        ...
        DataUtil.putSessionForHomePage(userId, roomId, System.currentTimeMillis() + 60 * 60 * 1000, session);
    }
